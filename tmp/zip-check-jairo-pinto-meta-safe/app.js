...
const getSiteConfig = () => {
  ...
  return {
    site: {
      id: 'jairo-pinto-test',
      title: 'Jairo Pinto — Rituales diarios con Gano Excel',
      appName: 'jairo_pinto_wellness',
      ogTitle: 'Jairo Pinto — Rituales diarios con Gano Excel',
      ogDescription: 'Cafés, cacao, suplementos y cuidado personal con Ganoderma para acompañar tu rutina con sabor y asesoría personalizada.',
      metaDescription: 'Descubre cafés, cacao, suplementos y cuidado personal con Ganoderma lucidum para acompañar tus momentos diarios.'
    },
    distributor: {
      ...
      defaultMessage: 'Hola Jairo, vengo de tu pagina web y me gustaria recibir asesoria para elegir un producto Gano Excel segun mi rutina.'
    },
    hero: {
...
function initWhatsAppLinks() {
  ...
  actionButtons.forEach(btn => {
    ...
    if (actionType === 'product') {
      ...
      message = `Hola ${firstName}, quiero hablar contigo para elegir un producto Gano Excel segun mi rutina.`;
