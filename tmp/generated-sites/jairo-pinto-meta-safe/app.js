...
const getSiteConfig = () => {
  ...
  return {
    site: {
      id: 'jairo-pinto-test',
      title: 'Jairo Pinto — Ganoderma orgánico con Gano Excel',
      appName: 'jairo_pinto_wellness',
      ogTitle: 'Jairo Pinto — Ganoderma orgánico con Gano Excel',
      ogDescription: 'Productos con extracto de Ganoderma lucidum para acompañar hábitos de bienestar con sabor, tradición botánica y asesoría personalizada.',
      metaDescription: 'Cafés, cacao, suplementos y cuidado personal con extracto de Ganoderma lucidum: tradición botánica, cultivo orgánico y bienestar diario.'
    },
    distributor: {
      ...
      defaultMessage: 'Hola Jairo, vengo de tu pagina web y me gustaria recibir asesoria sobre productos con Ganoderma de Gano Excel.'
    },
    hero: {
...
function initWhatsAppLinks() {
  ...
  actionButtons.forEach(btn => {
    ...
    if (actionType === 'product') {
      ...
      message = `Hola ${firstName}, quiero asesoria sobre el *${itemName}*. ¿Como puedo adquirirlo?`;
    } else if (actionType === 'contact') {
      message = `Hola ${firstName}, quiero hablar contigo para recibir asesoria sobre productos con Ganoderma de Gano Excel.`;
