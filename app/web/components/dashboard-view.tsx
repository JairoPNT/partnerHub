...
export function AdminDashboardPrototype() {
  ...
  return (
    <div className="space-y-8 animate-fade-in text-slate-900 dark:text-slate-100">
      {/* Title Section */}
      <section className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-5">
        <div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={isLoading}
            className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 shadow-sm hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200 transition"
          >
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 shadow-sm">
          ...
          <CardContent>
            <div className="text-3xl font-extrabold text-amber-600 dark:text-amber-400 font-heading">
      ...
      <section className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 shadow-sm">
          ...
          <CardContent className="space-y-3">
            <div className="flex items-center justify-between p-3 rounded-xl border border-amber-200 bg-amber-50/60 dark:border-amber-900/40 dark:bg-amber-950/20">
              <span className="text-xs font-bold text-amber-900 dark:text-amber-300 flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-amber-500" />
                NUEVO (Pendiente de contacto)
              </span>
              <span className="font-mono text-sm font-extrabold text-amber-950 dark:text-amber-200">
                {isLoading ? "-" : metrics?.newLeads ?? 0}
              </span>
            </div>

            <div className="flex items-center justify-between p-3 rounded-xl border border-blue-200 bg-blue-50/60 dark:border-blue-900/40 dark:bg-blue-950/20">
              ...
              <span className="font-mono text-sm font-extrabold text-blue-950 dark:text-blue-200">
                {isLoading ? "-" : metrics?.contactedLeads ?? 0}
              </span>
            </div>

            <div className="flex items-center justify-between p-3 rounded-xl border border-emerald-200 bg-emerald-50/60 dark:border-emerald-900/40 dark:bg-emerald-950/20">
              <span className="text-xs font-bold text-emerald-900 dark:text-emerald-300 flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-emerald-500" />
                PAGADO (Pago confirmado)
              </span>
              <span className="font-mono text-sm font-extrabold text-emerald-950 dark:text-emerald-200">
                {isLoading ? "-" : metrics?.paidLeads ?? 0}
              </span>
            </div>

            <div className="flex items-center justify-between p-3 rounded-xl border border-green-200 bg-green-50/60 dark:border-green-900/40 dark:bg-green-950/20">
              <span className="text-xs font-bold text-green-900 dark:text-green-300 flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-green-600" />
                CONVERTIDO (Sitio web operativo)
              </span>
              <span className="font-mono text-sm font-extrabold text-green-950 dark:text-green-200">
                {isLoading ? "-" : metrics?.convertedLeads ?? 0}
              </span>
            </div>

            <div className="flex items-center justify-between p-3 rounded-xl border border-rose-200 bg-rose-50/60 dark:border-rose-900/40 dark:bg-rose-950/20">
              <span className="text-xs font-bold text-rose-900 dark:text-rose-300 flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-rose-500" />
                CANCELADO
              </span>
              <span className="font-mono text-sm font-extrabold text-rose-950 dark:text-rose-200">
        ...
        <Card className="border-slate-200 bg-slate-50/70 dark:border-slate-800 dark:bg-slate-950 shadow-sm flex flex-col justify-between">
          <CardHeader>
            <CardTitle className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
          ...
          <CardContent className="space-y-3">
            <div className="p-3.5 rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 space-y-1">
              <div className="flex items-center justify-between text-xs font-bold text-slate-700 dark:text-slate-300">
                <span>Revenue Total (USD)</span>
                <span className="text-amber-700 dark:text-amber-400 font-mono text-xs">No disponible</span>
              </div>
          ...
          <div className="p-6 pt-0">
            <div className="rounded-2xl border border-cyan-200 bg-cyan-50/80 p-4 dark:border-cyan-900/60 dark:bg-cyan-950/40 space-y-2">
