...
Los objetos nuevos se suben con `Cache-Control: public, max-age=60, must-revalidate`. Durante el MVP priorizamos que las correcciones visuales se reflejen rapido; mas adelante se puede subir el cache para assets definitivos.
