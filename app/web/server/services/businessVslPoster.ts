...
export function applyBusinessVslPoster<T extends BusinessVslConfiguration>(configuration: T, isPartnerPage: boolean): T {
  ...
  return {
    ...
    vsl: {
      ...configuration.vsl,
      thumbnailUrl: resolveBusinessVslThumbnail(configuration.hero)
    }
  };
}
